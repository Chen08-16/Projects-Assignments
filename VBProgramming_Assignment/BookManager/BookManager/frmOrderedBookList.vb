...
Imports System.IO
Public Class frmOrderedBookList
    ...
    Private Sub frmOrderedBookList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MyDatAdp = New SqlDataAdapter("select * from OrderTable", Mycn)
